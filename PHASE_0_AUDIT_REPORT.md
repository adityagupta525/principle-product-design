...
> **STATUS UPDATE (DS v1.5):** All Library Gap items **G1–G13** identified in §4.2 of this report are now **RESOLVED** in Centricity DS v1.5 (Icon Swap System + Exposure Pass 2). This audit is preserved as-is below for the historical record; the gap list it opens is closed as of the v1.5 publish.
