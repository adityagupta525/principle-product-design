 ...
 *
 * Wordless again. It carried "Built for wealth distributors" for a while, but
 * that line is now the launch headline in Ignite at 0:06, and a film that says
 * the same thing twice 26 seconds apart is repeating itself, not landing it.
 * Detach and Flight are the send arc; they can carry it without commentary.
 */
